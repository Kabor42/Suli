...
/**
 * 3. Van olyan konstruktora, ami karakterbõl hoz létre sztringet.
 */
#if ELKESZULT >= 3
...
/**
 *  4. Van olyan konstruktora, ami C-sztringbõl (const char*) hoz létre sztringet.
 */
#if ELKESZULT >= 4
...
/**
 *  9. A tárolt a karakterek legyenek elérhetõek a szokásos módon indexeléssel!
 *     Az indexeléssel elért elem legyen használható balértékként is!
 *     A konstans objektumok is legyenek indexelhetõk.
...
/**
 * 11. Készítsen olyan fûzhetõ >> operátort, amivel be tud olvasni egy szót egy sztring-be!
 ...
 *     Segítségül elkészítettünk egy egyszerû kódrészletet ami szavakat olvas be,
 *     majd qsort() függvénnyel rendezi azokat.
 *     Az ékezetes karakterek kódolásával kapcsolatban korábban már volt egy egyszerû
