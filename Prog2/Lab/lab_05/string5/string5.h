 ...
 * azaz, sorban haladva hol tart a feladatok megoldásában!
 ...
 *
 * Korábban a len unsigned int volt. Most helyette a size_t típust használjuk.
...
/// Itt folytasa a tagfüggvények deklarációit.
    String();
    virtual ~String();
    String(size_t s);
    String(const char s);
